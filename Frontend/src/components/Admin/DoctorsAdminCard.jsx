    ...
    <div className="flex flex-col md:flex-row font-sans p-5 bg-white mb-10 rounded-lg mx-4 sm:mx-8 md:mx-12 lg:mx-16 xl:mx-20">
      ...
      <div className="border-2 p-6">
        ...
        <div className="flex justify-center mt-4">
          <button className="w-full p-2 font-semibold rounded-md bg-black text-white" onClick={() => deleteDoctor(prompt.drId)} type="submit">
            Delete
          </button>
...
export default DoctorsAdminCard;
