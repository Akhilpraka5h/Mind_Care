...
const AccountSettings = ({ onUpdate }) => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        setRole(role);
        const { firstName, lastName, phone, email, age, gender } =
          response.data;
  ...
  return (
    ...
    <>
    <Navbar />
      <div className=" pt-10 mx-auto max-w-screen-lg h-100vh">
        ...
        <div className="flex justify-center shadow-xl rounded-3xl">
          <div className="p-10">
            ...
            <div className="m-5">
              ...
              <div className="text-end text-blue-400 mx-5">
                <a>Change</a>
              </div>
            </div>
              ...
              <>
                ...
                <div className="m-5">
                  <div className="flex flex-col">
                    ...
                    <input
                      type="text"
                      placeholder="Eg.- Mentalist , M.B.B.S"
                ...
                <div className="m-5">
                  <div className="flex flex-col">
                    ...
                    <input
                      type="text"
                      placeholder="Eg.- New York City, USA"
                      value={address}
            ...
            <div className="m-5">
              <div className="flex flex-col">
                ...
                <textarea
                  placeholder="Eg.- Share your thoughts and feelings..."
                  value={about}
            ...
            <div className="m-5">
              ...
              <p>
                Account deletion imminent. All data will be lost permanently.
                Proceed with caution.
              </p>
              <div className="flex justify-between my-6">
                <button className="bg-gray-200 px-10 py-2 rounded">
                  Cancel
                </button>
                <button
                  onClick={handleUpdateClick}
                  className="bg-blue-400 px-10 py-2 rounded"
                >
                  Save
                </button>
              </div>
          ...
          <div className="p-8 m-6 s:w-1/2">
            <form>
              <label htmlFor="image-upload">
                {previewImage ? (
                  <img
                    className="size-32 mx-auto rounded-full avtar-preview"
                    src={previewImage}
                    alt="Profile Picture"
                  />
                ) : (
              ...
              <label
                ...
                className="bg-blue-400 px-6 py-2 rounded mt-4 inline-block "
              >
                Change
              </label>
            </form>
